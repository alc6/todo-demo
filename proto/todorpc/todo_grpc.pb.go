...
func (c *todosClient) CreateTodo(ctx context.Context, in *CreateTodoReq, opts ...grpc.CallOption) (*CreateTodoResp, error) {
	...
	err := c.cc.Invoke(ctx, "/todorpc.Todos/CreateTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todosClient) ReadTodo(ctx context.Context, in *ReadTodoReq, opts ...grpc.CallOption) (*ReadTodoResp, error) {
	...
	err := c.cc.Invoke(ctx, "/todorpc.Todos/ReadTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todosClient) ReadAllTodo(ctx context.Context, in *ReadAllTodoReq, opts ...grpc.CallOption) (*ReadAllTodoResp, error) {
	...
	err := c.cc.Invoke(ctx, "/todorpc.Todos/ReadAllTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todosClient) DeleteTodo(ctx context.Context, in *DeleteTodoReq, opts ...grpc.CallOption) (*DeleteTodoResp, error) {
	...
	err := c.cc.Invoke(ctx, "/todorpc.Todos/DeleteTodo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Todos_CreateTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todorpc.Todos/CreateTodo",
	}
...
func _Todos_ReadTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todorpc.Todos/ReadTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Todos_ReadAllTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todorpc.Todos/ReadAllTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Todos_UpdateTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todorpc.Todos/UpdateTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _Todos_DeleteTodo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todorpc.Todos/DeleteTodo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
